...
public class ShowHidePassEditText extends EditText {
    private static final String TAG = ShowHidePassEditText.class.getSimpleName();
    ...
    public ShowHidePassEditText(Context context) {
        super(context);
        init(null);
    }

    public ShowHidePassEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ShowHidePassEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.pass_show);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.pass_off);
            ...
            visibilityIndicatorShow = R.drawable.pass_show;
            visibilityIndicatorHide = R.drawable.pass_off;
